...
function library:CreateSettingsTab(menu)
    ...
    creditsSection:AddText({text = "Ratsense.cc"})
    ...
    mainSection:AddBind({text = 'Open / Close', flag = 'togglebind', nomouse = true, noindicator = true, bind = Enum.KeyCode.K, callback = function()
